const cards = JSON.parse(
  JSON.stringify({
    ...
    ad: {
      ...
      keywords: ["Jump", "Charge", "Deflect", "Immune", "Impact", "Pierce"],
    ...
    af: {
      ...
      keywords: ["Enrage", "Guardian", "Teamwork", "Impact", "Pierce", "Scale", "Lethal"],
      ...
      history: [
        ...
        },
        {
          date: "19 November 2020",
          description:
            "Cost reduced from 95 to 90 points. Gained Wookiee Warrior tag and Scale keyword. Weapon gained Lethal keyword. Lost Expert Climber and Unhindered keywords.",
        },
      ],
      id: "af",
    },
    ag: {
      ...
      keywords: ["Jump", "Gunslinger", "Impervious", "Nimble", "Pierce"],
    ...
    aj: {
      ...
      keywords: ["Charge", "Duelist", "Indomitable", "Scale"],
      upgradeBar: ["heavy weapon", "training", "training", "gear", "grenades"],
      history: [
        {
          date: "19 November 2020",
          description:
            "Cost reduced from 75 to 69 points. Gained Wookiee Warrior tag and Scale keyword. Lost Expert Climber and Unhindered keywords.",
        },
      ],
      id: "aj",
    },
    ...
    am: {
      ...
      keywords: ["Danger Sense", "Dauntless", "Infiltrate"],
      upgradeBar: ["heavy weapon", "training", "comms", "gear", "armament", "grenades"],
      history: [
        {
          date: "19 November 2020",
    ...
    ao: {
      ...
      keywords: ["Vehicle", "Armor", "Climbing Vehicle", "Expert Climber", "Impact"],
    ...
    ap: {
      ...
      history: [
        ...
        },
        {
          date: "19 November 2020",
          description:
            "Cost reduced from 140 to 130 points. Gained Immunity to range 1 weapons as well as surge to crit.",
        },
      ],
      id: "ap",
    },
    aq: {
      ...
      keywords: ["Vehicle", "Arsenal", "Cover", "Light Transport: Open", "Speeder"],
    ...
    ar: {
      ...
      keywords: ["Spotter", "Inspire", "Sharpshooter"],
      history: [
        {
          date: "19 November 2020",
    ...
    at: {
      ...
      history: [
        ...
        },
        {
          date: "27 October 2021",
          description:
            "Cost increased from 175 to 190 points. Added Command upgrade slot and Compel: Corps Trooper.",
        },
      ],
      id: "at",
    },
    au: {
      ...
      keywords: ["Spotter", "Inspire", "Precise", "Sharpshooter", "Pierce"],
      upgradeBar: ["command", "command", "gear"],
      history: [
        {
          date: "27 October 2021",
    ...
    av: {
      ...
      keywords: ["Compel", "Cunning", "Entourage", "Sharpshooter", "Pierce"],
      upgradeBar: ["command", "command", "gear"],
      id: "av",
      cardType: "unit",
    ...
    bf: {
      ...
      keywords: ["Vehicle", "Cover", "Speeder", "Fixed", "Impact"],
      upgradeBar: ["comms"],
      history: [
        {
          date: "12 September 2019",
    ...
    bg: {
      ...
      keywords: ["Vehicle", "Armor", "Arsenal", "Weak Point", "Fixed", "Impact"],
      ...
      history: [
        {
          date: "19 November 2020",
          description:
            "Instead of performing 1 additional attack, he may perform an additional attack action even if he already attacked during his activation.",
        },
      ],
      id: "cq",
    },
      ...
      history: [
        {
          date: "19 November 2020",
          description:
            "Restricted to target non-commander, non-operative enemy trooper units instead of any enemy trooper units.",
        },
      ],
      id: "dw",
    },
    ...
    en: {
      ...
      keywords: ["Arm", "Detonate", "Blast", "Suppressive"],
      requirements: [
        "OR",
        {cardName: "Scout Troopers"},
        {cardName: "Scout Troopers Strike Team"},
    ...
    ew: {
      ...
      imageName: "Imperial Officer.jpeg",
      keywords: ["Inspire", "Leader"],
      requirements: ["AND", {rank: "corps"}, {faction: "empire"}],
      history: [
        {
          date: "19 November 2020",
    ...
    ez: {
      ...
      keywords: ["Treat", "Noncombatant"],
      requirements: ["AND", {faction: "empire"}, {rank: "corps"}],
      id: "ez",
    },
    fa: {
      cardSubtype: "personnel",
    ...
    fk: {
      ...
      requirements: ["AND", {cardSubtype: "repulsor vehicle"}, {faction: "rebels"}],
      history: [
        {
          date: "19 November 2020",
        ...
        },
        {
          date: "27 October 2021",
          description:
            "Cost increased from 1 to 5 points. Added Field Commander keyword.",
        },
      ],
      id: "fk",
    },
    ...
    fn: {
      ...
      history: [
        ...
        },
        {
          date: "27 October 2021",
          description:
            "Cost increased from 155 to 175 points. Increased wound threshold from 6 to 7. Increased speed from 1 to 2. Removed Spur keyword.",
        },
      ],
      id: "fn",
    },
    ...
    fy: {
      ...
      keywords: ["Gunslinger", "Scout", "Scouting Party", "Sharpshooter", "Tactical"],
      history: [
        {
          date: "27 October 2021",
      ...
      history: [
        {
          date: "19 November 2020",
          description:
            "Cost reduced from 32 to 28 points. Wound threshold increased from 1 to 2.",
        },
      ],
      id: "gs",
    },
    ...
    hz: {
      ...
      requirements: [
        "OR",
        ["OR", {cardSubtype: "ground vehicle"}, {cardSubtype: "repulsor vehicle"}],
        {cardSubtype: "emplacement trooper"},
      ],
      id: "hz",
    },
    ...
    ic: {
      ...
      keywords: ["Vehicle", "Arsenal", "Cover", "Speeder", "Fixed"],
      ...
      history: [
        {
          date: "19 November 2020",
          description:
            "Cost increased from 10 to 15 points. Added 'During the Command Phase' timing.",
        },
      ],
      id: "ik",
    },
    ...
    jg: {
      ...
      keywords: ["Repair", "Secret Mission", "Grounded", "Inconspicuous", "Suppressive"],
      upgradeBar: ["comms"],
      history: [
        {
          date: "19 November 2020",
    ...
    kf: {
      ...
      keywords: ["Covert Ops", "Danger Sense", "Loadout", "Marksman", "Tactical"],
    ...
    kx: {
      ...
      upgradeBar: ["training", "training", "comms", "gear", "armament", "grenades"],
      history: [
        {
          date: "27 October 2021",
          description: "Cost reduced from 125 to 120 points.",
    ...
    ky: {
      ...
      keywords: ["Heavy Weapon Team", "Impervious", "Scout", "Sharpshooter", "Tactical"],
      upgradeBar: ["heavy weapon", "training", "comms", "gear", "gear", "grenades"],
      history: [
        {
          date: "19 November 2020",
    ...
    kz: {
      ...
      keywords: ["Impervious", "Scout", "Sharpshooter", "Tactical"],
      upgradeBar: ["heavy weapon", "training", "comms", "gear", "gear", "grenades"],
      history: [
        {
          date: "19 November 2020",
    ...
    la: {
      ...
      keywords: ["AI", "Impervious", "Scale", "Scout", "Sharpshooter"],
      upgradeBar: ["heavy weapon", "training", "comms", "armament", "grenades"],
      history: [
        {
          date: "5 June 2023",
    ...
    lb: {
      ...
      upgradeBar: ["heavy weapon", "training", "comms", "grenades", "armament"],
      id: "lb",
    },
    lc: {
      id: "lc",
    ...
    lf: {
      ...
      keywords: ["Critical", "Immune", "Deflect", "Lethal", "Pierce"],
      requirements: [
        "OR",
        {cardName: "ARC Troopers"},
        {cardName: "ARC Troopers Strike Team"},
    ...
    lh: {
      ...
      requirements: [
        "OR",
        ["OR", {cardName: "ARC Troopers"}, {cardName: "ARC Troopers Strike Team"}],
        ["AND", {rank: "corps"}, {cardSubtype: "clone trooper"}],
      ],
      history: [
        {
          date: "27 October 2021",
    ...
    ln: {
      ...
      keywords: ["Permanent", "Secret Mission", "Reliable", "Divulge", "Infiltrate"],
      id: "ln",
    },
    lo: {
    ...
    lu: {
      ...
      requirements: ["OR", {cardName: "Jyn Erso"}, {cardName: "K-2SO"}],
    },
    lv: {
      cardType: "unit",
      faction: "rebels",
      ...
      detachment: "kf",
      keywords: ["Calculate Odds", "Armor", "Detachment", "Incognito", "Teamwork"],
    ...
    lw: {
      ...
      keywords: ["Counterpart", "Recharge", "Shielded", "Small"],
      cardSubtype: "droid trooper",
      id: "lw",
    },
    lx: {
    ...
    mc: {
      ...
      products: [],
      faction: "separatists",
      keywords: ["Agile", "AI", "Coordinate", "Cover", "Speeder", "Critical", "Fixed"],
      upgradeBar: ["comms"],
      history: [
        {
          date: "27 October 2021",
    ...
    me: {
      ...
      requirements: [
        ...
        [
          "OR",
          ["AND", {rank: "corps"}, {cardSubtype: "trooper"}],
          [
            "OR",
    ...
    mk: {
      ...
      products: [],
      faction: "rebels",
      keywords: ["Jump", "Impervious", "Nimble"],
      upgradeBar: ["heavy weapon", "training", "comms", "gear", "armament", "grenades"],
      id: "mk",
      history: [
        {
    ...
    ml: {
      ...
      products: [],
      faction: "rebels",
      keywords: ["Equip", "Jump", "Impervious", "Nimble", "Retinue"],
      upgradeBar: [
        "heavy weapon",
        "heavy weapon",
        "training",
    ...
    mq: {
      ...
      requirements: ["AND", {faction: "separatists"}, {cardSubtype: "droid trooper"}],
    },
    mr: {
      id: "mr",
      cardSubtype: "gear",
    ...
    mx: {
      ...
      products: [],
      faction: "empire",
      keywords: ["Infiltrate", "Marksman", "Reliable"],
      upgradeBar: ["heavy weapon", "training", "training", "comms", "gear", "grenades"],
    },
    my: {
      id: "my",
      cardType: "unit",
      ...
      products: [],
      faction: "empire",
      keywords: ["Equip", "Infiltrate", "Marksman", "Reliable", "Retinue"],
      upgradeBar: [
        "heavy weapon",
        "heavy weapon",
        "training",
    ...
    nb: {
      ...
      products: [],
      faction: "separatists",
      keywords: ["Jump", "Deflect", "Immune", "Juyo Mastery", "Impact", "Pierce"],
      upgradeBar: ["force", "force", "training", "training"],
    },
    nc: {
      id: "nc",
    ...
    ne: {
      ...
      keywords: [],
      requirements: ["OR", {rank: "commander"}, {rank: "operative"}],
    },
    nf: {
      id: "nf",
      displayName: "",
      ...
      products: [],
      faction: "republic",
      keywords: ["Permanent", "Outmaneuver", "Relentless"],
    },
    ng: {
      id: "ng",
      displayName: "",
      ...
      products: [],
      faction: "republic",
      keywords: ["Permanent", "Master of the Force"],
    },
    nh: {
      id: "nh",
      displayName: "",
    ...
    nk: {
      ...
      detachment: "nb",
      keywords: ["Detachment", "Observe", "Hover", "Incognito", "Suppressive"],
      upgradeBar: ["comms"],
      id: "nk",
    },
    nl: {
    ...
    nr: {
      ...
      imageName: "T-Series Tactical Droid.jpeg",
      flaw: "",
      keywords: ["Bolster", "Direct", "Sharpshooter"],
      upgradeBar: ["command", "comms", "gear"],
      id: "nr",
    },
    ns: {
      cardType: "unit",
    ...
    nx: {
      ...
      products: [],
      faction: "republic",
      keywords: ["Field Commander", "Beam", "Immune"],
    },
    ny: {
      id: "ny",
      displayName: "",
    ...
    od: {
      ...
      cost: 18,
      imageName: "Clone Commander.jpeg",
      keywords: ["Inspire", "Reliable", "Leader"],
      requirements: [{cardSubtype: "clone trooper"}],
      history: [
        {
          date: "8 December 2022",
    ...
    on: {
      ...
      upgradeBar: ["pilot", "ordnance", "comms"],
      history: [
        {
          date: "27 October 2021",
          description: "Cost reduced from 120 to 105 points.",
    ...
    os: {
      ...
      keywords: ["Field Commander"],
      requirements: ["AND", {faction: "republic"}, {cardName: "LAAT Patrol Transport"}],
    },
    ot: {
      id: "ot",
      displayName: "",
    ...
    ov: {
      ...
      keywords: ["Sharpshooter"],
      requirements: ["AND", {faction: "rebels"}, {cardSubtype: "repulsor vehicle"}],
    },
    ow: {
      id: "ow",
      displayName: "",
    ...
    pb: {
      ...
      keywords: ["Marksman"],
      requirements: ["AND", {faction: "empire"}, {cardSubtype: "repulsor vehicle"}],
      history: [
        {
          date: "27 October 2021",
          description: "Cost reduced from 12 to 8 points.",
    ...
    pg: {
      ...
      flaw: "",
      keywords: ["Indomitable", "Scale", "Sharpshooter"],
      upgradeBar: ["heavy weapon", "training", "gear", "grenades"],
      id: "pg",
    },
    ph: {
      cardType: "unit",
      ...
      upgradeBar: ["command", "training", "training", "gear"],
      id: "ph",
    },
    pi: {
      id: "pi",
    ...
    px: {
      ...
      keywords: ["AI", "Charge", "Guardian", "Immune", "Retinue", "Unhindered"],
    ...
    py: {
      ...
      keywords: ["Strategize", "Direct", "Override", "Sharpshooter", "Lethal"],
    ...
    pz: {
      ...
      keywords: ["Strategize", "Charge", "Override", "Sharpshooter", "Lethal", "Pierce"],
    ...
    qa: {
      ...
      keywords: ["Strategize", "Direct", "Reinforcements", "Sharpshooter", "Lethal"],
    ...
    qh: {
      ...
      keywords: ["Cover", "Immune", "Reposition", "Speeder"],
      upgradeBar: ["crew", "comms"],
      history: [],
    },
    qi: {
    ...
    qs: {
      ...
      keywords: ["Armor", "Cover", "Hover", "Weak Point"],
      upgradeBar: ["pilot", "hardpoint", "comms"],
      history: [],
    },
    qt: {
    ...
    qy: {
      ...
      keywords: ["Aid", "Independent", "Danger Sense"],
      upgradeBar: ["command", "gear"],
      history: [
        {
          date: "8 December 2022",
    ...
    qz: {
      ...
      keywords: ["Self-Preservation", "Danger Sense", "Outmaneuver", "Independent"],
      upgradeBar: ["heavy weapon", "personnel", "gear", "grenades"],
      history: [
        {
          date: "8 December 2022",
    ...
    rb: {
      ...
      keywords: ["Dauntless", "Precise", "Self-Preservation", "Independent"],
      upgradeBar: ["heavy weapon", "personnel", "gear", "grenades"],
      history: [
        {
          date: "5 June 2023",
    ...
    rc: {
      ...
      upgradeBar: ["force", "force", "command", "training", "armament"],
      history: [],
    },
    rd: {
      id: "rd",
    ...
    re: {
      ...
      upgradeBar: ["heavy weapon", "training", "comms", "gear", "grenades", "armament"],
      history: [
        {
          date: "5 June 2023",
          description: "Cost reduced from 75 to 70 points.",
    ...
    sn: {
      ...
      keywords: [],
      requirements: ["AND", {rank: "heavy"}, {faction: "fringe"}],
    },
    so: {
      id: "so",
      displayName: "",
    ...
    sq: {
      ...
      flaw: "",
      keywords: ["Cover", "Independent", "Reinforcements", "Speeder", "Overrun"],
      upgradeBar: ["comms"],
      history: [
        {
          date: "5 June 2023",
    ...
    sr: {
      ...
      keywords: ["Flexible Response", "Precise", "Unhindered", "Special Issue"],
    ...
    ti: {
      ...
      upgradeBar: ["training", "comms", "gear"],
    },
    tj: {
      id: "tj",
      cardType: "unit",
      ...
      counterpartId: "tn",
      keywords: ["Armor X", "Gunslinger", "Impervious", "Programmed", "Sharpshooter"],
    ...
    tk: {
      ...
      upgradeBar: ["training", "training", "comms", "gear", "gear", "armament"],
      history: [],
    },
    tl: {
      id: "tl",
    ...
    tm: {
      ...
      keywords: ["Armor", "Plodding", "Unconcerned", "Unstoppable"],
      upgradeBar: ["heavy weapon", "heavy weapon", "personnel", "programming"],
      history: [],
    },
    tn: {
      id: "tn",
      ...
      keywords: ["Hunted", "Latent Power", "Small", "Claim"],
      cardSubtype: "trooper",
    },
    to: {
      id: "to",
      ...
      keywords: ["Immobilize", "Suppressive"],
      requirements: [{cardName: "Din Djarin"}],
    },
    tp: {
      id: "tp",
      displayName: "",
    ...
    ue: {
      ...
      keywords: ["Observe", "Jump", "Take Cover", "Direct", "Target"],
      upgradeBar: ["command", "training", "gear"],
      history: [],
    },
    uf: {
    ...
    ui: {
      ...
      keywords: ["Observe", "Entourage", "Ruthless", "Sharpshooter", "Tactical"],
      upgradeBar: ["command", "command", "training", "gear", "armament"],
    ...
    ve: {
      ...
      upgradeBar: ["training", "training", "training"],
      history: [],
      id: "ve",
    },
    vf: {
    ...
    vk: {
      ...
      keywords: ["Low Profile", "Unhindered"],
      upgradeBar: ["heavy weapon", "personnel", "training"],
      history: [],
      id: "vk",
    },
    vl: {
    ...
    vp: {
      ...
      requirements: [
        "OR",
        ["OR", {cardName: "Wicket"}, {cardName: "Logray"}],
        ["OR", {cardName: "Ewok Skirmishers"}, {cardName: "Ewok Slingers"}],
      ],
      history: [],
    },
    vq: {
    ...
    vr: {
      ...
      requirements: ["OR", {cardName: "Ewok Skirmishers"}, {cardName: "Ewok Slingers"}],
      history: [],
    },
    vs: {
      id: "vs",
    ...
    vu: {
      ...
      keywords: ["Independent", "Low Profile", "Target", "Unhindered", "Primitive"],
      upgradeBar: ["heavy weapon", "personnel", "training"],
      history: [],
      id: "vu",
    },
    ...
    wd: {
      ...
      keywords: ["Aid", "Independent", "Inspire", "Low Profile", "Nimble", "Suppressive"],
      upgradeBar: ["command", "training", "training", "training"],
      history: [],
      id: "wd",
    },
    we: {
    ...
    wl: {
      ...
      keywords: ["Dauntless", "Block", "Enrage", "Immune", "Ram", "Impact", "Pierce"],
      upgradeBar: ["training", "training", "force"],
      history: [],
      id: "wl",
    },
    wm: {
    ...
    wn: {
      ...
      keywords: ["Jump", "Compel", "Entourage", "Override", "Weighed Down"],
      upgradeBar: ["command", "command", "comms", "gear"],
      history: [],
      id: "wn",
    },
    ...
    wp: {
      ...
      keywords: ["Jump", "Scale", "Death From Above", "Weighed Down"],
      upgradeBar: ["heavy weapon", "personnel"],
      history: [],
      id: "wp",
    },
    wq: {
      ...
      keywords: [],
      requirements: ["OR", {cardName: "Fifth Brother"}, {cardName: "Seventh Sister"}],
      history: [],
    },
    wr: {
      id: "wr",
    ...
    xd: {
      ...
      keywords: ["AI", "Charge", "Guardian", "Unhindered", "Special Issue"],
    ...
    xh: {
      ...
      keywords: ["Advanced Targeting", "Armor", "Indomitable", "Scale", "Spur"],
      upgradeBar: ["heavy weapon", "personnel", "grenades", "comms"],
      id: "xh",
    },
    xi: {
      cardType: "unit",
    ...
    xj: {
      ...
      upgradeBar: ["training", "gear", "grenades", "comms", "armament"],
      id: "xj",
    },
    xk: {
    ...
    xp: {
      ...
      upgradeBar: ["training", "training", "gear", "grenades", "comms", "armament"],
      id: "xp",
    },
    xq: {
      id: "xq",
