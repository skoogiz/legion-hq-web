...
const battleForcesDict: BattleForces = {
  "Echo Base Defenders": {
    ...
    ruleUrl:
      "https://cdn.svc.asmodee.net/production-amgcom/uploads/2022/10/StarWarsLegionBFRulesSheetEBD.pdf",
    "standard mode": {
      commander: [1, 4],
      operative: [0, 3],
      corps: [3, 6],
  ...
  "Blizzard Force": {
    ...
    ruleUrl:
      "https://cdn.svc.asmodee.net/production-amgcom/uploads/2023/09/Star-Wars-Legion-BF-Rules-Sheet-BF2.1.pdf",
  ...
  "Imperial Remnant": {
    ...
    heavy: ["tm"],
    ruleUrl:
      "https://cdn.svc.asmodee.net/production-amgcom/uploads/2023/09/ImperialRemnantRulesSheet.pdf",
  ...
  "Tempest Force": {
    ...
    heavy: ["we", "bg"],
    ruleUrl:
      "https://cdn.svc.asmodee.net/production-amgcom/uploads/2023/07/SWL_TempestForce.pdf",
  ...
  "501st Legion": {
    ...
    heavy: ["oo"],
    ruleUrl:
      "https://cdn.svc.asmodee.net/production-amgcom/uploads/2022/10/StarWarsLegionBFRulesSheet501.pdf",
  ...
  "Wookiee Defenders": {
    ...
    heavy: ["gb", "qs"],
    ruleUrl:
      "https://cdn.svc.asmodee.net/production-amgcom/uploads/2023/09/SWL_WookieesDefenders-1.pdf",
    allowedUniqueUpgrades: ["lh", "lg"],
    "standard mode": {
      commander: [1, 2],
      operative: [0, 0],
  ...
  "Experimental Droids": {
    ...
    heavy: ["xe"],
    ruleUrl:
      "https://cdn.svc.asmodee.net/production-amgcom/uploads/2023/09/SWL_ExperimentalDroids-1.pdf",
    allowedUniqueUpgrades: [],
    "standard mode": {
      commander: [1, 2],
      operative: [0, 0],
  ...
  "Shadow Collective": {
    ...
    ruleUrl:
      "https://cdn.svc.asmodee.net/production-amgcom/uploads/2022/10/StarWarsLegionBFRulesSheetSC.pdf",
